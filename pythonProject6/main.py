...
#melt,Pandas.melt() unpivots a DataFrame from wide format to long format.
...
app.layout= html.Div([
    html.Div([
        ...
        html.Div([
            html.H6('Last Update: ' + str(covid_data_1['date'].iloc[-1].strftime("%B %d, %Y")) + '  00:01 (GMT)',
                style={'color':'orange'}),
        ])
